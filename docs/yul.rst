...
which allows to specialized Yul to the requirements of different
target platforms and feature sets.

All expressions, variables and literals in Yul have a type,
and there is a default type that does not have to be mentioned explicitly.
...
Multiple syntactical elements can follow each other simply seperated by
...
variables at the same time. For this, the number and types of the values...
...
Contrary to other programming languages, for safety reasons, control flow generally does not...
